...
- Tools that use Analyses (e.g. Analyze, ...) now have a new option/Analysis called IMUDataReporter where Output signals are reported for IMUs on the model, or can be reported for user specified Frames.
