...
public final class VisualizerWindowAction implements ActionListener {
    ...
    public void actionPerformed(ActionEvent e) {
            ...
            VisualizationJson json = ExportSceneToThreeJsAction.exportCurrentModelToJson(JettyMain.getServerRootDir()+"/threejs/editor/scene.json", OpenSimDB.getInstance().getCurrentModel());
