 ...
 * @author Ayman
 */
public abstract class DisablableOpenSimObjectNode extends OpenSimObjectNode implements DisableableObject {
    protected boolean disabled = false;

    public DisablableOpenSimObjectNode(OpenSimObject obj) {
        super(obj);
        updateDisabledFlag();
    }
