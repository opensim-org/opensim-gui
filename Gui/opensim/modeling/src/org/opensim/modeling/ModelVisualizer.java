...
public class ModelVisualizer {
  ...
  public static boolean findGeometryFile(Model aModel, String geoFile, SWIGTYPE_p_bool isAbsolute, SimTKArrayString attempts) {
    return opensimModelJNI.ModelVisualizer_findGeometryFile(Model.getCPtr(aModel), aModel, geoFile, SWIGTYPE_p_bool.getCPtr(isAbsolute), SimTKArrayString.getCPtr(attempts), attempts);
  }
