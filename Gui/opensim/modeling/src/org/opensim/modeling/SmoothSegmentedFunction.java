...
public class SmoothSegmentedFunction {
  ...
  public SWIGTYPE_p_SimTK__Vec2 getCurveDomain() {
    return new SWIGTYPE_p_SimTK__Vec2(opensimModelJNI.SmoothSegmentedFunction_getCurveDomain(swigCPtr, this), true);
  }
  ...
  public SWIGTYPE_p_SimTK__Matrix calcSampledMuscleCurve(int maxOrder, double domainMin, double domainMax) {
    return new SWIGTYPE_p_SimTK__Matrix(opensimModelJNI.SmoothSegmentedFunction_calcSampledMuscleCurve(swigCPtr, this, maxOrder, domainMin, domainMax), true);
  }
