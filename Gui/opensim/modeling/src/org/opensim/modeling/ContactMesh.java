...
public class ContactMesh extends ContactGeometry {
  ...
  public ContactMesh(String filename, SWIGTYPE_p_SimTK__Vec3 location, SWIGTYPE_p_SimTK__Vec3 orientation, Body body) {
    this(opensimModelJNI.new_ContactMesh__SWIG_1(filename, SWIGTYPE_p_SimTK__Vec3.getCPtr(location), SWIGTYPE_p_SimTK__Vec3.getCPtr(orientation), Body.getCPtr(body), body), true);
  }

  public ContactMesh(String filename, SWIGTYPE_p_SimTK__Vec3 location, SWIGTYPE_p_SimTK__Vec3 orientation, Body body, String name) {
    this(opensimModelJNI.new_ContactMesh__SWIG_2(filename, SWIGTYPE_p_SimTK__Vec3.getCPtr(location), SWIGTYPE_p_SimTK__Vec3.getCPtr(orientation), Body.getCPtr(body), body, name), true);
  }
