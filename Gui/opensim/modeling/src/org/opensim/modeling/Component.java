...
public class Component extends OpenSimObject {
  ...
  /**
   * Returns `true` if `subcomponent`, which should be a direct subcomponent<br>
   * of this component, was successfully removed from this component.<br>
   * <br>
   * Specifically, this tries to remove a direct component that was<br>
   * previously added via `addComponent`, or existed in the `&lt;components&gt;`<br>
