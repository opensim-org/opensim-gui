...
/**
 * A Study that performs an Inverse Kinematics analysis with a given model.<br>
 * Inverse kinematics is the solution of internal coordinates that poses<br>
 * the model such that the body rotations (as measured by IMUs) affixed to the <br>
 * model minimize the weighted least-squares error with observations of IMU <br>
 * orientations in their spatial coordinates. <br>
 * <br>
 * @author Ajay Seth
 */
