...
public class StdVectorIMUs extends java.util.AbstractList<IMU> implements java.util.RandomAccess {
  ...
  public static long swigRelease(StdVectorIMUs obj) {
    long ptr = 0;
    if (obj != null) {
      if (!obj.swigCMemOwn)
  ...
  private int doCapacity() {
    return opensimSimulationJNI.StdVectorIMUs_doCapacity(swigCPtr, this);
  }

  private void doReserve(int n) {
    opensimSimulationJNI.StdVectorIMUs_doReserve(swigCPtr, this, n);
  }
