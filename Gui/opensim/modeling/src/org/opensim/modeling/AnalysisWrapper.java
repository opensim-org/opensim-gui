...
public class AnalysisWrapper extends Analysis {
  ...
  public int step(State s, int stepNumber) {
    return (getClass() == AnalysisWrapper.class) ? opensimModelJNI.AnalysisWrapper_step(swigCPtr, this, State.getCPtr(s), s, stepNumber) : opensimModelJNI.AnalysisWrapper_stepSwigExplicitAnalysisWrapper(swigCPtr, this, State.getCPtr(s), s, stepNumber);
  }
