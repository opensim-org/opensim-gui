...
public class MarkerPlacer extends OpenSimObject {
  ...
  public boolean processModel(State s, Model aModel, String aPathToSubject) {
    return opensimModelJNI.MarkerPlacer_processModel__SWIG_0(swigCPtr, this, State.getCPtr(s), s, Model.getCPtr(aModel), aModel, aPathToSubject);
  }

  public boolean processModel(State s, Model aModel) {
    return opensimModelJNI.MarkerPlacer_processModel__SWIG_1(swigCPtr, this, State.getCPtr(s), s, Model.getCPtr(aModel), aModel);
  }
