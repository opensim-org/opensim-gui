...
/**
 * A class implementing a Gimbal joint. The underlying implementation Simbody is a<br>
 * SimTK::MobilizedBody::Gimbal. The opensim Gimbal joint implementation uses a <br>
 *  X-Y-Z body fixed Euler sequence for generalized coordinates calculation.<br>
 * Gimbal joints have a singularity when Y is near  \frac{\pi}{2}.<br>
 * Generalized speeds are equal to the Euler angle derivatives  ( \vec{u} = \dot{\vec{q}})<br>
 * <br>
 * <img src=gimbalJoint.gif/><br>
 * <br>
 * @author Tim Dorn<br>
 * @author Ajay Seth
 */
public class GimbalJoint extends Joint {
  ...
  public Coordinate getCoordinate() {
    return new Coordinate(opensimSimulationJNI.GimbalJoint_getCoordinate__SWIG_0_0(swigCPtr, this), false);
  }
  ...
  public Coordinate updCoordinate() {
    return new Coordinate(opensimSimulationJNI.GimbalJoint_updCoordinate__SWIG_0_0(swigCPtr, this), false);
  }
