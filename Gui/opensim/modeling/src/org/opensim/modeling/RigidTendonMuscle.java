...
/**
 * A class implementing a RigidTendonMuscle actuator with no states.<br>
 * The path information for a RigidTendonMuscle is contained<br>
 * in the base class, and the force-generating behavior should is defined in<br>
 * this class. The force (muscle tension) assumes rigid tendon so that <br>
 * fiber-length and velocity are kinematics dependent and the force-length<br>
 * force-velocity relationships are evaluated directly.<br>
 * The control of this model is its activation. Force production is instantaneous  <br>
 * with no excitation-to-activation dynamics and excitation=activation.<br>
 * <br>
 * @author Ajay Seth
 */
