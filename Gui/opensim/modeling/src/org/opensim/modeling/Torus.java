...
/**
 * A class to represent Torus geometry. The torus is centered at the<br>
 * origin with the axial direction aligned to the z-axis. It is defined by<br>
 * a ring_radius (radius of the circular centerline of the torus, measured<br>
 * from the origin), and a cross_section (radius of the torus cross-section:<br>
