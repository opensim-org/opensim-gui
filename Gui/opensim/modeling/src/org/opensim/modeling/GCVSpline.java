...
public class GCVSpline extends Function {
  ...
  public GCVSpline(int aDegree, int aN, SWIGTYPE_p_double aTimes, SWIGTYPE_p_double aValues, String aName, double aErrorVariance) {
    this(opensimModelJNI.new_GCVSpline__SWIG_1(aDegree, aN, SWIGTYPE_p_double.getCPtr(aTimes), SWIGTYPE_p_double.getCPtr(aValues), aName, aErrorVariance), true);
  }

  public GCVSpline(int aDegree, int aN, SWIGTYPE_p_double aTimes, SWIGTYPE_p_double aValues, String aName) {
    this(opensimModelJNI.new_GCVSpline__SWIG_2(aDegree, aN, SWIGTYPE_p_double.getCPtr(aTimes), SWIGTYPE_p_double.getCPtr(aValues), aName), true);
  }

  public GCVSpline(int aDegree, int aN, SWIGTYPE_p_double aTimes, SWIGTYPE_p_double aValues) {
    this(opensimModelJNI.new_GCVSpline__SWIG_3(aDegree, aN, SWIGTYPE_p_double.getCPtr(aTimes), SWIGTYPE_p_double.getCPtr(aValues)), true);
  }
