...
/**
 * <br>
 * A class that represents a half space (that is, everything to one side of an<br>
 * infinite plane) for use in contact modeling.<br>
 * <br>
 * In its local coordinate system, all points for which x&gt;0 are considered to be<br>
 * inside the geometry. Its location and orientation properties can be used to<br>
 * move and rotate it to represent other half spaces.<br>
 * <br>
 * A `SimTK::ContactGeometry::TriangleMesh` is constructed when<br>
