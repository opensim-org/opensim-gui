...
public class ContactHalfSpace extends ContactGeometry {
  ...
  public ContactHalfSpace(SWIGTYPE_p_SimTK__Vec3 location, SWIGTYPE_p_SimTK__Vec3 orientation, Body body) {
    this(opensimModelJNI.new_ContactHalfSpace__SWIG_1(SWIGTYPE_p_SimTK__Vec3.getCPtr(location), SWIGTYPE_p_SimTK__Vec3.getCPtr(orientation), Body.getCPtr(body), body), true);
  }

  public ContactHalfSpace(SWIGTYPE_p_SimTK__Vec3 location, SWIGTYPE_p_SimTK__Vec3 orientation, Body body, String name) {
    this(opensimModelJNI.new_ContactHalfSpace__SWIG_2(SWIGTYPE_p_SimTK__Vec3.getCPtr(location), SWIGTYPE_p_SimTK__Vec3.getCPtr(orientation), Body.getCPtr(body), body, name), true);
  }
