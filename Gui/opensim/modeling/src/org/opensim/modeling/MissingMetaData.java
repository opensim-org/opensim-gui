...
public class MissingMetaData extends OpenSimException {
  ...
  public MissingMetaData(long cPtr, boolean cMemoryOwn) {
    super(opensimModelJNI.MissingMetaData_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        opensimModelJNI.delete_MissingMetaData(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public MissingMetaData(String file, long line, String func, String key) {
    this(opensimModelJNI.new_MissingMetaData(file, line, func, key), true);
  }
