...
public class HuntCrossleyForce extends Force {
  ...
  public SWIGTYPE_p_OpenSim__PropertyT_OpenSim__ContactParametersSet_t getProperty_contact_parameters() {
    return new SWIGTYPE_p_OpenSim__PropertyT_OpenSim__ContactParametersSet_t(opensimModelJNI.HuntCrossleyForce_getProperty_contact_parameters(swigCPtr, this), false);
  }

  public SWIGTYPE_p_OpenSim__PropertyT_OpenSim__ContactParametersSet_t updProperty_contact_parameters() {
    return new SWIGTYPE_p_OpenSim__PropertyT_OpenSim__ContactParametersSet_t(opensimModelJNI.HuntCrossleyForce_updProperty_contact_parameters(swigCPtr, this), false);
  }
  ...
  public ArrayDouble getRecordValues(SWIGTYPE_p_SimTK__State state) {
    return new ArrayDouble(opensimModelJNI.HuntCrossleyForce_getRecordValues(swigCPtr, this, SWIGTYPE_p_SimTK__State.getCPtr(state)), true);
  }
