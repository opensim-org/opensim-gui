...
public class Model extends ModelComponent {
  ...
  private void private_addModelComponent(ModelComponent adoptee) {
    opensimModelJNI.Model_private_addModelComponent(swigCPtr, this, ModelComponent.getCPtr(adoptee), adoptee);
  }

  private void private_addBody(Body adoptee) {
    opensimModelJNI.Model_private_addBody(swigCPtr, this, Body.getCPtr(adoptee), adoptee);
  }

  public void addJoint(Joint adoptee) {
    opensimModelJNI.Model_addJoint(swigCPtr, this, Joint.getCPtr(adoptee), adoptee);
  }

  private void private_addConstraint(Constraint adoptee) {
    opensimModelJNI.Model_private_addConstraint(swigCPtr, this, Constraint.getCPtr(adoptee), adoptee);
  }

  private void private_addForce(Force adoptee) {
    opensimModelJNI.Model_private_addForce(swigCPtr, this, Force.getCPtr(adoptee), adoptee);
  }

  private void private_addProbe(Probe adoptee) {
    opensimModelJNI.Model_private_addProbe(swigCPtr, this, Probe.getCPtr(adoptee), adoptee);
  }

  private void private_addContactGeometry(ContactGeometry adoptee) {
    opensimModelJNI.Model_private_addContactGeometry(swigCPtr, this, ContactGeometry.getCPtr(adoptee), adoptee);
  }

  public void addFrame(Frame adoptee) {
    opensimModelJNI.Model_addFrame(swigCPtr, this, Frame.getCPtr(adoptee), adoptee);
  }

  public void addMarker(Marker adoptee) {
    opensimModelJNI.Model_addMarker(swigCPtr, this, Marker.getCPtr(adoptee), adoptee);
  }
  ...
  private void private_addAnalysis(Analysis adoptee) {
    opensimModelJNI.Model_private_addAnalysis(swigCPtr, this, Analysis.getCPtr(adoptee), adoptee);
  }

  private void private_addController(Controller adoptee) {
    opensimModelJNI.Model_private_addController(swigCPtr, this, Controller.getCPtr(adoptee), adoptee);
  }
