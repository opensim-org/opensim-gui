...
public class AbstractTool extends OpenSimObject {
  ...
  /**
   * %Set the model to be investigated.<br>
  ...
  /**
   * Load and construct a model based on the property settings of<br>
   * this investigation.
   */
  ...
  /**
   * Adds Analysis objects from analysis set to model.<br>
   * <br>
   * NOTE: Makes copies of analyses.  Also, both this tool and the model have ownership of their analysis<br>
   * objects, therefore making a copy is necessary so a single analysis won't be deleted twice.<br>
   * <br>
   * To avoid leaking when the tool is run from the GUI, pointers to the model's copy of the analyses<br>
   * are kept around so that they can be removed at the end of tool execution.<br>
   ...
   * <br>
   * @param aBaseName Basename file to which to print the data.<br>
   * @param aDir Directory to which to print the data into.<br>
   * @param aDT Time interval between results (linear interpolation is used).<br>
   * If not included as an argument or negative, all time steps are printed<br>
