...
public class ContactSphere extends ContactGeometry {
  ...
  public ContactSphere(double radius, SWIGTYPE_p_SimTK__Vec3 location, Body body) {
    this(opensimModelJNI.new_ContactSphere__SWIG_1(radius, SWIGTYPE_p_SimTK__Vec3.getCPtr(location), Body.getCPtr(body), body), true);
  }

  public ContactSphere(double radius, SWIGTYPE_p_SimTK__Vec3 location, Body body, String name) {
    this(opensimModelJNI.new_ContactSphere__SWIG_2(radius, SWIGTYPE_p_SimTK__Vec3.getCPtr(location), Body.getCPtr(body), body, name), true);
  }
