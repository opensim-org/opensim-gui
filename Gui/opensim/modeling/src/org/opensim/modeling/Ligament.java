...
public class Ligament extends Force {
  ...
  public void computeForce(State s, SWIGTYPE_p_SimTK__Vector_T_SimTK__SpatialVec_t bodyForces, Vector generalizedForces) {
    opensimModelJNI.Ligament_computeForce(swigCPtr, this, State.getCPtr(s), s, SWIGTYPE_p_SimTK__Vector_T_SimTK__SpatialVec_t.getCPtr(bodyForces), Vector.getCPtr(generalizedForces), generalizedForces);
  }
