...
public class ModelComponentIterator {
  ...
  public int getModelingOption(State state, String path) {
    return opensimSimulationJNI.ModelComponentIterator_getModelingOption(swigCPtr, this, State.getCPtr(state), state, path);
  }
  ...
  public void setModelingOption(State state, String path, int flag) {
    opensimSimulationJNI.ModelComponentIterator_setModelingOption(swigCPtr, this, State.getCPtr(state), state, path, flag);
  }
