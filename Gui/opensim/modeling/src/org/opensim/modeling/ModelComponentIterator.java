...
public class ModelComponentIterator {
  ...
  public Vec3 getScaleFactors(ScaleSet scaleSet, Frame frame) {
    return new Vec3(opensimSimulationJNI.ModelComponentIterator_getScaleFactors(swigCPtr, this, ScaleSet.getCPtr(scaleSet), scaleSet, Frame.getCPtr(frame), frame), true);
  }
  ...
  public void updateXMLNode(SWIGTYPE_p_SimTK__Xml__Element parent) {
    opensimSimulationJNI.ModelComponentIterator_updateXMLNode(swigCPtr, this, SWIGTYPE_p_SimTK__Xml__Element.getCPtr(parent));
  }
