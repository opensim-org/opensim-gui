...
public class opensimCommon {
  ...
  public static boolean isValidFileName(SWIGTYPE_p_PropertyT_std__string_t value) {
    return opensimCommonJNI.isValidFileName(SWIGTYPE_p_PropertyT_std__string_t.getCPtr(value));
  }
