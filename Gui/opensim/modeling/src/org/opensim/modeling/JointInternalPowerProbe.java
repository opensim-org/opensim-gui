...
public class JointInternalPowerProbe extends Probe {
  ...
  public SWIGTYPE_p_SimTK__Vector computeProbeInputs(SWIGTYPE_p_SimTK__State state) {
    return new SWIGTYPE_p_SimTK__Vector(opensimModelJNI.JointInternalPowerProbe_computeProbeInputs(swigCPtr, this, SWIGTYPE_p_SimTK__State.getCPtr(state)), true);
  }
