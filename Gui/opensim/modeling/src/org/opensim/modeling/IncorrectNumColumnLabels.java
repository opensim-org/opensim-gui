...
public class IncorrectNumColumnLabels extends IOError {
  ...
  public IncorrectNumColumnLabels(long cPtr, boolean cMemoryOwn) {
    super(opensimModelJNI.IncorrectNumColumnLabels_SWIGUpcast(cPtr), cMemoryOwn);
    swigCPtr = cPtr;
  }
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwn) {
        swigCMemOwn = false;
        opensimModelJNI.delete_IncorrectNumColumnLabels(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public IncorrectNumColumnLabels(String file, long line, String func, String filename, long expected, long received) {
    this(opensimModelJNI.new_IncorrectNumColumnLabels(file, line, func, filename, expected, received), true);
  }
