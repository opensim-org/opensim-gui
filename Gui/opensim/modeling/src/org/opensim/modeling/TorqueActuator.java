...
public class TorqueActuator extends Actuator {
  ...
  public SWIGTYPE_p_OpenSim__PropertyT_SimTK__Vec3_t getProperty_axis() {
    return new SWIGTYPE_p_OpenSim__PropertyT_SimTK__Vec3_t(opensimModelJNI.TorqueActuator_getProperty_axis(swigCPtr, this), false);
  }

  public SWIGTYPE_p_OpenSim__PropertyT_SimTK__Vec3_t updProperty_axis() {
    return new SWIGTYPE_p_OpenSim__PropertyT_SimTK__Vec3_t(opensimModelJNI.TorqueActuator_updProperty_axis(swigCPtr, this), false);
  }

  public SWIGTYPE_p_SimTK__Vec3 get_axis(int i) {
    return new SWIGTYPE_p_SimTK__Vec3(opensimModelJNI.TorqueActuator_get_axis__SWIG_0(swigCPtr, this, i), false);
  }

  public SWIGTYPE_p_SimTK__Vec3 upd_axis(int i) {
    return new SWIGTYPE_p_SimTK__Vec3(opensimModelJNI.TorqueActuator_upd_axis__SWIG_0(swigCPtr, this, i), false);
  }

  public void set_axis(int i, SWIGTYPE_p_SimTK__Vec3 value) {
    opensimModelJNI.TorqueActuator_set_axis__SWIG_0(swigCPtr, this, i, SWIGTYPE_p_SimTK__Vec3.getCPtr(value));
  }

  public int append_axis(SWIGTYPE_p_SimTK__Vec3 value) {
    return opensimModelJNI.TorqueActuator_append_axis(swigCPtr, this, SWIGTYPE_p_SimTK__Vec3.getCPtr(value));
  }

  public void constructProperty_axis(SWIGTYPE_p_SimTK__Vec3 initValue) {
    opensimModelJNI.TorqueActuator_constructProperty_axis(swigCPtr, this, SWIGTYPE_p_SimTK__Vec3.getCPtr(initValue));
  }

  public SWIGTYPE_p_SimTK__Vec3 get_axis() {
    return new SWIGTYPE_p_SimTK__Vec3(opensimModelJNI.TorqueActuator_get_axis__SWIG_1(swigCPtr, this), false);
  }

  public SWIGTYPE_p_SimTK__Vec3 upd_axis() {
    return new SWIGTYPE_p_SimTK__Vec3(opensimModelJNI.TorqueActuator_upd_axis__SWIG_1(swigCPtr, this), false);
  }

  public void set_axis(SWIGTYPE_p_SimTK__Vec3 value) {
    opensimModelJNI.TorqueActuator_set_axis__SWIG_1(swigCPtr, this, SWIGTYPE_p_SimTK__Vec3.getCPtr(value));
  }
  ...
  public void setAxis(SWIGTYPE_p_SimTK__Vec3 axis) {
    opensimModelJNI.TorqueActuator_setAxis(swigCPtr, this, SWIGTYPE_p_SimTK__Vec3.getCPtr(axis));
  }

  public SWIGTYPE_p_SimTK__Vec3 getAxis() {
    return new SWIGTYPE_p_SimTK__Vec3(opensimModelJNI.TorqueActuator_getAxis(swigCPtr, this), false);
  }
