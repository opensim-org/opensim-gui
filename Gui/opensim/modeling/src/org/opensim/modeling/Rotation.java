...
public class Rotation extends Mat33 {
  ...
  public static Vec4 OLDconvertAngVelDotToQuaternionDotDot(Vec4 q, Vec3 w_PB_P, Vec3 wdot_PB_P) {
    return new Vec4(opensimModelJNI.Rotation_OLDconvertAngVelDotToQuaternionDotDot(Vec4.getCPtr(q), q, Vec3.getCPtr(w_PB_P), w_PB_P, Vec3.getCPtr(wdot_PB_P), wdot_PB_P), true);
  }
