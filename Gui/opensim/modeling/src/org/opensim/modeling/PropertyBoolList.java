...
public class PropertyBoolList extends AbstractProperty {
  ...
  /**
   *  Append a <i>copy</i> of the supplied <i>value</i> to the end of this <br>
   *     property's value list. An exception is thrown if the property can't hold <br>
   *     any more values. The index assigned to this value is returned. Note that <br>
   *     although we  accept a pointer here, we do not take over ownership. See <br>
