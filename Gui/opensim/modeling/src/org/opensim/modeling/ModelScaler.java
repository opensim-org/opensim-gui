...
public class ModelScaler extends OpenSimObject {
  ...
  public boolean processModel(State s, Model aModel, String aPathToSubject, double aFinalMass) {
    return opensimModelJNI.ModelScaler_processModel__SWIG_0(swigCPtr, this, State.getCPtr(s), s, Model.getCPtr(aModel), aModel, aPathToSubject, aFinalMass);
  }

  public boolean processModel(State s, Model aModel, String aPathToSubject) {
    return opensimModelJNI.ModelScaler_processModel__SWIG_1(swigCPtr, this, State.getCPtr(s), s, Model.getCPtr(aModel), aModel, aPathToSubject);
  }

  public boolean processModel(State s, Model aModel) {
    return opensimModelJNI.ModelScaler_processModel__SWIG_2(swigCPtr, this, State.getCPtr(s), s, Model.getCPtr(aModel), aModel);
  }
