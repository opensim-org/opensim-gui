...
public class UniversalJoint extends Joint {
  ...
  public Coordinate getCoordinate() {
    return new Coordinate(opensimModelSimulationJNI.UniversalJoint_getCoordinate__SWIG_0_0(swigCPtr, this), false);
  }

  public Coordinate updCoordinate() {
    return new Coordinate(opensimModelSimulationJNI.UniversalJoint_updCoordinate__SWIG_0_0(swigCPtr, this), false);
  }

  public Coordinate getCoordinate(UniversalJoint.Coord idx) {
    return new Coordinate(opensimModelSimulationJNI.UniversalJoint_getCoordinate__SWIG_1(swigCPtr, this, idx.swigValue()), false);
  }

  public Coordinate updCoordinate(UniversalJoint.Coord idx) {
    return new Coordinate(opensimModelSimulationJNI.UniversalJoint_updCoordinate__SWIG_1(swigCPtr, this, idx.swigValue()), false);
  }

  public UniversalJoint() {
    this(opensimModelSimulationJNI.new_UniversalJoint__SWIG_0(), true);
  }

  public UniversalJoint(String name, PhysicalFrame parent, PhysicalFrame child) {
    this(opensimModelSimulationJNI.new_UniversalJoint__SWIG_1(name, PhysicalFrame.getCPtr(parent), parent, PhysicalFrame.getCPtr(child), child), true);
  }
