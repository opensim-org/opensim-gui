...
public class DataTableVec6 extends AbstractDataTable {
  ...
  protected DataTableVec6(long cPtr, boolean cMemoryOwn) {
    super(opensimModelCommonJNI.DataTableVec6_SWIGSmartPtrUpcast(cPtr), true);
  ...
  public synchronized void delete() {
    if (swigCPtr != 0) {
      if (swigCMemOwnDerived) {
        ...
        opensimModelCommonJNI.delete_DataTableVec6(swigCPtr);
      }
      swigCPtr = 0;
    }
    super.delete();
  ...
  public DataTableVec6() {
    this(opensimModelCommonJNI.new_DataTableVec6__SWIG_0(), true);
  }

  public DataTableVec6(DataTableVec6 arg0) {
    this(opensimModelCommonJNI.new_DataTableVec6__SWIG_1(DataTableVec6.getCPtr(arg0), arg0), true);
  }

  public DataTableVec6(String filename, String tablename) {
    this(opensimModelCommonJNI.new_DataTableVec6__SWIG_2(filename, tablename), true);
  }

  public DataTable flatten() {
    return new DataTable(opensimModelCommonJNI.DataTableVec6_flatten__SWIG_0(swigCPtr, this), true);
  }

  public DataTable flatten(StdVectorString suffixes) {
    return new DataTable(opensimModelCommonJNI.DataTableVec6_flatten__SWIG_1(swigCPtr, this, StdVectorString.getCPtr(suffixes), suffixes), true);
  }

  public long numComponentsPerElement() {
    return opensimModelCommonJNI.DataTableVec6_numComponentsPerElement(swigCPtr, this);
  }

  public void appendRow(double indRow, SWIGTYPE_p_std__initializer_listT_SimTK__VecT_6_double_1_t_t container) {
    opensimModelCommonJNI.DataTableVec6_appendRow__SWIG_1(swigCPtr, this, indRow, SWIGTYPE_p_std__initializer_listT_SimTK__VecT_6_double_1_t_t.getCPtr(container));
  }

  public void appendRow(double indRow, SWIGTYPE_p_SimTK__RowVector_T_SimTK__VecT_6_double_1_t_t depRow) {
    opensimModelCommonJNI.DataTableVec6_appendRow__SWIG_3(swigCPtr, this, indRow, SWIGTYPE_p_SimTK__RowVector_T_SimTK__VecT_6_double_1_t_t.getCPtr(depRow));
  }

  public void appendRow(double indRow, SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t depRow) {
    opensimModelCommonJNI.DataTableVec6_appendRow__SWIG_4(swigCPtr, this, indRow, SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t.getCPtr(depRow));
  }

  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t getRowAtIndex(long index) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_getRowAtIndex(swigCPtr, this, index), true);
  }

  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t getRow(double ind) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_getRow(swigCPtr, this, ind), true);
  }

  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t updRowAtIndex(long index) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_updRowAtIndex(swigCPtr, this, index), true);
  }

  public SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t updRow(double ind) {
    return new SWIGTYPE_p_SimTK__RowVectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_updRow(swigCPtr, this, ind), true);
  }

  public void removeRowAtIndex(long index) {
    opensimModelCommonJNI.DataTableVec6_removeRowAtIndex(swigCPtr, this, index);
  }

  public void removeRow(double ind) {
    opensimModelCommonJNI.DataTableVec6_removeRow(swigCPtr, this, ind);
  }

  public StdVectorDouble getIndependentColumn() {
    return new StdVectorDouble(opensimModelCommonJNI.DataTableVec6_getIndependentColumn(swigCPtr, this), false);
  }

  public SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t getDependentColumnAtIndex(long index) {
    return new SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_getDependentColumnAtIndex(swigCPtr, this, index), true);
  }

  public SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t getDependentColumn(String columnLabel) {
    return new SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_getDependentColumn(swigCPtr, this, columnLabel), true);
  }

  public SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t updDependentColumnAtIndex(long index) {
    return new SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_updDependentColumnAtIndex(swigCPtr, this, index), true);
  }

  public SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t updDependentColumn(String columnLabel) {
    return new SWIGTYPE_p_SimTK__VectorView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_updDependentColumn(swigCPtr, this, columnLabel), true);
  }

  public void setIndependentValueAtIndex(long rowIndex, double value) {
    opensimModelCommonJNI.DataTableVec6_setIndependentValueAtIndex(swigCPtr, this, rowIndex, value);
  }

  public SWIGTYPE_p_SimTK__MatrixView_T_SimTK__VecT_6_double_1_t_t getMatrix() {
    return new SWIGTYPE_p_SimTK__MatrixView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_getMatrix(swigCPtr, this), false);
  }
  ...
  public SWIGTYPE_p_SimTK__MatrixView_T_SimTK__VecT_6_double_1_t_t getMatrixBlock(long rowStart, long columnStart, long numRows, long numColumns) {
    return new SWIGTYPE_p_SimTK__MatrixView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_getMatrixBlock(swigCPtr, this, rowStart, columnStart, numRows, numColumns), true);
  }

  public SWIGTYPE_p_SimTK__MatrixView_T_SimTK__VecT_6_double_1_t_t updMatrix() {
    return new SWIGTYPE_p_SimTK__MatrixView_T_SimTK__VecT_6_double_1_t_t(opensimModelCommonJNI.DataTableVec6_updMatrix(swigCPtr, this), false);
  }
