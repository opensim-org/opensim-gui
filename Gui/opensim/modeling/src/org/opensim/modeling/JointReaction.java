...
public class JointReaction extends Analysis {
  ...
  public int begin(SWIGTYPE_p_SimTK__State s) {
    return opensimModelJNI.JointReaction_begin(swigCPtr, this, SWIGTYPE_p_SimTK__State.getCPtr(s));
  }

  public int step(SWIGTYPE_p_SimTK__State s, int setNumber) {
    return opensimModelJNI.JointReaction_step(swigCPtr, this, SWIGTYPE_p_SimTK__State.getCPtr(s), setNumber);
  }

  public int end(SWIGTYPE_p_SimTK__State s) {
    return opensimModelJNI.JointReaction_end(swigCPtr, this, SWIGTYPE_p_SimTK__State.getCPtr(s));
  }
