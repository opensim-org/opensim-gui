...
public class BodyIterator {
  ...
  public Transform getTransformInMobilizedBody() {
    return new Transform(opensimModelJNI.BodyIterator_getTransformInMobilizedBody(swigCPtr, this), true);
  }

  public Transform getGroundTransform(State state) {
    return new Transform(opensimModelJNI.BodyIterator_getGroundTransform(swigCPtr, this, State.getCPtr(state), state), true);
  }
  ...
  public Vec3 expressVectorInAnotherFrame(State state, Vec3 vec, Frame otherFrame) {
    return new Vec3(opensimModelJNI.BodyIterator_expressVectorInAnotherFrame(swigCPtr, this, State.getCPtr(state), state, Vec3.getCPtr(vec), vec, Frame.getCPtr(otherFrame), otherFrame), true);
  }

  public Vec3 findLocationInAnotherFrame(State state, Vec3 point, Frame otherFrame) {
    return new Vec3(opensimModelJNI.BodyIterator_findLocationInAnotherFrame(swigCPtr, this, State.getCPtr(state), state, Vec3.getCPtr(point), point, Frame.getCPtr(otherFrame), otherFrame), true);
  }
