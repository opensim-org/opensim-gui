...
public class ArrayPtrsObj {
  ...
  public int getIndex(OpenSimObject aObject, int aStartIndex) {
    return opensimModelCommonJNI.ArrayPtrsObj_getIndex__SWIG_0(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject, aStartIndex);
  }

  public int getIndex(OpenSimObject aObject) {
    return opensimModelCommonJNI.ArrayPtrsObj_getIndex__SWIG_1(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject);
  }
  ...
  public boolean remove(OpenSimObject aObject) {
    return opensimModelCommonJNI.ArrayPtrsObj_remove__SWIG_1(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject);
  }
  ...
  public int searchBinary(OpenSimObject aObject, boolean aFindFirst, int aLo, int aHi) {
    return opensimModelCommonJNI.ArrayPtrsObj_searchBinary__SWIG_0(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject, aFindFirst, aLo, aHi);
  }

  public int searchBinary(OpenSimObject aObject, boolean aFindFirst, int aLo) {
    return opensimModelCommonJNI.ArrayPtrsObj_searchBinary__SWIG_1(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject, aFindFirst, aLo);
  }

  public int searchBinary(OpenSimObject aObject, boolean aFindFirst) {
    return opensimModelCommonJNI.ArrayPtrsObj_searchBinary__SWIG_2(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject, aFindFirst);
  }

  public int searchBinary(OpenSimObject aObject) {
    return opensimModelCommonJNI.ArrayPtrsObj_searchBinary__SWIG_3(swigCPtr, this, OpenSimObject.getCPtr(aObject), aObject);
  }
